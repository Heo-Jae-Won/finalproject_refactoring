...
const AboutPage = () => {
  return (
    <div>
        ...
        <Carousel>
          <Carousel.Item>
            <img
              ...
              src="/image/ub.jpg" height={570} alt="빈 이미지"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
      ...
      <div className='ub'>
        <img src='/image/jungo_auto_x2.jpg' width={1407} height={1060} alt="빈 이미지"/>
      </div>
      <div className='item'  >
            <img src="/image/k1.png" alt="빈 이미지"/>
            <img src="/image/k2.png" alt="빈 이미지"/>

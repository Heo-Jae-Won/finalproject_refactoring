...
import { getPboardLikeUser, onDislikeClicked, onLikeClicked } from '../util/axios/pboard';
...
const PboardItem = ({ postList, callPlike }) => {
  ...
  const callLikeList = useCallback(async () => {
    const result = await getPboardLikeUser(pcode, loginUser.unickname)

...
const users_edit_documnet=(request.user.id===document.owner_id);
if(users_edit_documnet){
  //user can edit this document
}

if(!users_edit_documnet){
  //user cannot edit this document
}
  ...
  return (
    <div className='event_notice'>
      ...
      <Button style={{marginTop:100}} onClick={() => { history.go(-1) }}>목록으로</Button>
    </div>
  )
}
